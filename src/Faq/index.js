    ...
    return (
      ...
      <div id="faqContent"> 
          ...
          <p>
            ...
            are so many different clubs - ranging from STEM related clubs, Debate clubs, Art clubs, Technology clubs, Music Clubs,
          ...
          <p>
            ...
            development of Hkis Clubs! Your feedback is incredibly important to improving the website. Please let us
            know your feedback on our feedback form.{" "}
          </p>
          ...
          <li>  Search for clubs by name or sort through the different categories using the clubs filter </li>
          <li>
          ...
          <p>
            ...
            the responsibility to attend club meetings
          ...
          <p>
            {" "}
            Joining clubs is one of the best ways to explore your interests. Learn more about each club by browsing through the club page.{" "}
          </p>
          ...
          <p>
            ...
            Browse through clubs, bookmark clubs, and when you find a club that interest you,
            click on the card to learn more about the club.{" "}
          </p>
          <p id="line">  </p>
          ...
          <p>
            {" "}
            Sorry about that! As a club leader, you will have access to editing your club on the website via the admin portal. 
